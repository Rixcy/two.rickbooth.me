...
> 2, or 99. The opcode indicates what to do; for example, `99` means that the program is finished
...
If the optcode is `1`, add the first input and second input together, then replace the number at the
output position with the result

If the optcode is `2`, multiply the first and second input together, then replace the number at the
output position with the result
